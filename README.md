...
Опубликован 28 мая 2026, попал в топ-дайджест AI-комьюнити [Klabs](https://t.me/klabs_chat) Мари Афониной («Алмазы дня · 28 мая», 1-е место).
...
Я не из IT — куратор онлайн-клуба инвестиций «Семья». AI Lab — личный проект, выросший из практической задачи: понять, какие модели можно безопасно использовать в работе с клиентами клуба (финансовые расчёты — где ошибка стоит реальных денег) и какие точно нельзя.
...
[tori74](https://github.com/tori74) — куратор онлайн-клуба инвестиций «Семья», AI-консультант в рабочей практике, разработка через Claude Code.
